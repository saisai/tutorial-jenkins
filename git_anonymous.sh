...
{
    git -c user.name="saisai" -c user.email="sai@gmail.com" commit -m $comment -- $file
}

function editCommit
{
    git -c user.name="saisai" -c user.email="sai@gmail.com" commit -am "$comment"
}

function addCommit
{
    git -c user.name="saisai" -c user.email="sai@gmail.com" commit -m $comment
}
